...
const updateProduct = async (req, res) => {
    ...
    const { id } = req.params;   // yaha change kiya
    const { name, description, price, discountPrice, category, brand, sku, stock, isActive } = req.body;
    ...
    try {
        ...
        const updateprod = await Product.findByIdAndUpdate(
            id,
            { name, description, price, discountPrice, category, brand, sku, stock, isActive },
...
// // Backend Controller
// const Product = require("../models/Product"); // Apne model ka path check karein

// const updateProduct = async (req, res) => {
//     const { id } = req.params;
//     // Saari fields jo aapne mangi thi
//     const { name, description, price, discountPrice, category, brand, sku, stock, isActive } = req.body;
...
// // Single Product lane ke liye (Edit form bharne ke liye)
...
// module.exports = { updateProduct, getProductById };